...
INSERT INTO `aluno` VALUES (1,0,1);
...
INSERT INTO `area` VALUES (1,'Literatura'),(2,'Informática'),(3,'Química');
...
INSERT INTO `autor` VALUES (1,'J. K. Rowling'),(2,'William Shakespeare'),(3,'José de Alencar');
...
INSERT INTO `cargo` VALUES (1,'Professor',0),(2,'Bibliotecário',0),(3,'Coordenador',0);
...
INSERT INTO `curso` VALUES (1,'Informática Para Internet',0,0,1),(2,'Logística',0,0,1),(3,'Contabilidade',980,30,2),(4,'Segurança do Trabalho',1080,30,1),(5,'Meio Ambiente',1200,30,1);
...
INSERT INTO `editora` VALUES (1,'Objetiva'),(2,'Nova Tec'),(3,'Rocco');
...
INSERT INTO `endereco` VALUES (1,'Rua Uru','',10,'Jardim Suíço',75143650,'Anápolis','GO'),(2,'Avenida N-003','Quadra 14 Lote 16',10,'Anápolis City',75094080,'Anápolis','GO');
...
INSERT INTO `formacao` VALUES (1,'Ensino Fundamental Completo'),(2,'Ensino Superior Completo'),(3,'Ensino Médio Completo');
...
INSERT INTO `funcionario` VALUES (1,2,1,2);
...
INSERT INTO `livro` VALUES (1,'8573025034','Romeu e Julieta',2000,'Romance Jovem',1,'1',1,1),(2,'1020304050','Harry Potter',2003,'Aventura',1,'1',1,3);
...
INSERT INTO `livro_has_autor` VALUES (1,2),(2,1),(2,2),(2,3);
...
INSERT INTO `senha` VALUES (1,'qwer1234','2018-05-14 08:43:46',1),(2,'12345rewq','2018-05-14 09:32:55',2);
...
INSERT INTO `tipo` VALUES (1,'Técnico'),(2,'EAD');
...
INSERT INTO `turma` VALUES (1,'2018-05-14','2020-05-14',1),(2,'2018-05-14','2020-05-14',1),(3,'2018-06-10','2020-06-10',3);
...
INSERT INTO `usuario` VALUES (1,'Bruno Sousa Ferreira','03830310102',6298270328,62982703288,'bruno21vk@gmail.com','1991-11-15',0,'2018-05-14 08:43:46','2018-05-14 08:43:46',1),(2,'Vinicius Alves','43746558629',6233174545,62991252525,'vinicius.alves@gmail.com','1993-03-21',0,'2018-05-14 09:32:55','2018-05-14 09:32:55',2);
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_curso_turma_insert`(pinicio datetime, ptermino datetime, pidcurso int)
BEGIN
...
-- Dump completed on 2018-05-19 11:46:34
